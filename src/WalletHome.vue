...
import { useAuthUserData } from './store/user.js'
...
// TODO: use userData sub-interface which has not-null seed on type level
const rootSecretKey = ergo.ExtSecretKey.derive_master(authUserData.seed)
...
const pkBytes = ref(walletPublicKey.pub_key_bytes())
const skBytes = ref(walletSecretKey.secret_key_bytes())
